      ...
      <div className="container-max">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-96 lg:h-[500px] rounded-2xl overflow-hidden shadow-2xl">
            <iframe
              src="https://maps.app.goo.gl/E5eJpzZjv1feDoQT9"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-4">
                    Visit our showroom and warehouse for immediate parts availability and expert consultation.
                  </p>
                  <a
                    href="https://maps.app.goo.gl/E5eJpzZjv1feDoQT9"
                    target="_blank"
