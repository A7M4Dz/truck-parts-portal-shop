        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 mb-12 md:mb-16 px-4">
          ...
          <div className="order-2">
            ...
            <ul className="space-y-3 md:space-y-4">
              <li><button onClick={() => scrollToSection("#brands")} className="text-gray-300 hover:text-white transition-colors text-base md:text-lg hover:text-blue-400 relative group min-h-[44px] flex items-center">
                {t('nav.about')}
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-400 transition-all duration-300 group-hover:w-full"></span>
              </button></li>
              <li><button onClick={() => scrollToSection("#quotation")} className="text-gray-300 hover:text-white transition-colors text-base md:text-lg hover:text-blue-400 relative group min-h-[44px] flex items-center">
                {t('nav.products')}
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-400 transition-all duration-300 group-hover:w-full"></span>
              </button></li>
              <li><button onClick={() => scrollToSection("#location")} className="text-gray-300 hover:text-white transition-colors text-base md:text-lg hover:text-blue-400 relative group min-h-[44px] flex items-center">
                {t('nav.branches')}
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-400 transition-all duration-300 group-hover:w-full"></span>
              </button></li>
              <li><button onClick={() => scrollToSection("#contact")} className="text-gray-300 hover:text-white transition-colors text-base md:text-lg hover:text-blue-400 relative group min-h-[44px] flex items-center">
                {t('nav.contact')}
                <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-blue-400 transition-all duration-300 group-hover:w-full"></span>
              </button></li>
            </ul>
          ...
          <div className="order-3">
            ...
            <div className="space-y-3 md:space-y-4 text-gray-300">
              ...
              <p className="flex items-center text-base md:text-lg">
                <MapPin className="mr-3 text-blue-400 flex-shrink-0" size={18} /> 
